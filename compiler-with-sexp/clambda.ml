...
type ustructured_constant = Compiler_without_sexp.Clambda.ustructured_constant =
...
and uphantom_defining_expr = Compiler_without_sexp.Clambda.uphantom_defining_expr =
...
and ulambda = Compiler_without_sexp.Clambda.ulambda =
  ...
  | Ulet of mutable_flag * value_kind * Backend_var.With_provenance.t * ulambda * ulambda
  | Uphantom_let of
  ...
  | Ucatch of int * (Backend_var.With_provenance.t * value_kind) list * ulambda * ulambda
  | Utrywith of ulambda * Backend_var.With_provenance.t * ulambda
  | Uifthenelse of ulambda * ulambda * ulambda
  | Usequence of ulambda * ulambda
  | Uwhile of ulambda * ulambda
  | Ufor of Backend_var.With_provenance.t * ulambda * ulambda * direction_flag * ulambda
...
type function_description = Compiler_without_sexp.Clambda.function_description =
...
type uconstant_block_field = Compiler_without_sexp.Clambda.uconstant_block_field =
...
type preallocated_constant = Compiler_without_sexp.Clambda.preallocated_constant =
  { symbol : string
  ; exported : bool
...
include (
  Compiler_without_sexp.Clambda :
    module type of struct
      include Compiler_without_sexp.Clambda
    end
    with type function_description := Compiler_without_sexp.Clambda.function_description
     and type function_label := Compiler_without_sexp.Clambda.function_label
     and type preallocated_block := Compiler_without_sexp.Clambda.preallocated_block
     and type preallocated_constant := Compiler_without_sexp.Clambda.preallocated_constant
     and type uconstant := Compiler_without_sexp.Clambda.uconstant
     and type uconstant_block_field := Compiler_without_sexp.Clambda.uconstant_block_field
     and type ufunction := Compiler_without_sexp.Clambda.ufunction
     and type ulambda := Compiler_without_sexp.Clambda.ulambda
     and type ulambda_switch := Compiler_without_sexp.Clambda.ulambda_switch
     and type uphantom_defining_expr :=
          Compiler_without_sexp.Clambda.uphantom_defining_expr
     and type ustructured_constant := Compiler_without_sexp.Clambda.ustructured_constant
     and type usymbol_provenance := Compiler_without_sexp.Clambda.usymbol_provenance
     and type value_approximation := Compiler_without_sexp.Clambda.value_approximation)
