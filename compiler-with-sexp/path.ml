...
include (
  Compiler_without_sexp.Path :
    module type of struct
      include Compiler_without_sexp.Path
    end
    with type t := Compiler_without_sexp.Path.t
     and type typath := Compiler_without_sexp.Path.typath
     and module Map := Compiler_without_sexp.Path.Map
     and module Set := Compiler_without_sexp.Path.Set)
