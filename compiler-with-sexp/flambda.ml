...
type call_kind = Compiler_without_sexp.Flambda.call_kind =
  | Indirect 
  | Direct of Closure_id.t [@@deriving sexp_of]
type const = Compiler_without_sexp.Flambda.const =
  | Int of int 
  | Char of char 
  | Const_pointer of int [@@deriving sexp_of]
type apply = Compiler_without_sexp.Flambda.apply =
  ...
  specialise: Lambda.specialise_attribute }[@@deriving sexp_of]
type assign = Compiler_without_sexp.Flambda.assign =
  {
  being_assigned: Mutable_variable.t ;
  new_value: Variable.t }[@@deriving sexp_of]
type send = Compiler_without_sexp.Flambda.send =
  ...
  obj: Variable.t ;
  args: Variable.t list ;
  dbg: Debuginfo.t }[@@deriving sexp_of]
...
type specialised_to = Compiler_without_sexp.Flambda.specialised_to =
  {
  var: Variable.t ;
  projection: Projection.t option }[@@deriving sexp_of]
...
and function_declarations =
  Compiler_without_sexp.Flambda.function_declarations = private
  {
  is_classic_mode: bool ;
  set_of_closures_id: Set_of_closures_id.t ;
  set_of_closures_origin: Set_of_closures_origin.t ;
  funs: function_declaration Variable.Map.t }
and function_declaration = Compiler_without_sexp.Flambda.function_declaration
  = private
  {
...
and constant_defining_value_block_field =
  ...
  | Symbol of Symbol.t 
  | Const of const [@@deriving sexp_of]
...
type program_body = Compiler_without_sexp.Flambda.program_body =
  ...
  | End of Symbol.t [@@deriving sexp_of]
type program = Compiler_without_sexp.Flambda.program =
  {
  imported_symbols: Symbol.Set.t ;
  program_body: program_body }[@@deriving sexp_of]
module With_free_variables =
  struct
    type 'a t =
      (('a Compiler_without_sexp.Flambda.With_free_variables.t)[@sexp.opaque
                                                                 ])[@@deriving
                                                                    sexp_of]
    include
      (Compiler_without_sexp.Flambda.With_free_variables :
        module type of
          ...
          'a Compiler_without_sexp.Flambda.With_free_variables.t)
  end
type maybe_named = Compiler_without_sexp.Flambda.maybe_named =
  | Is_expr of t 
  | Is_named of named [@@deriving sexp_of]
include
  (Compiler_without_sexp.Flambda :
    module type of struct include Compiler_without_sexp.Flambda end with type
       apply :=  Compiler_without_sexp.Flambda.apply and type  assign := 
      Compiler_without_sexp.Flambda.assign and type  call_kind := 
      Compiler_without_sexp.Flambda.call_kind and type  const := 
      Compiler_without_sexp.Flambda.const and type
       constant_defining_value := 
      Compiler_without_sexp.Flambda.constant_defining_value and type
       constant_defining_value_block_field := 
      Compiler_without_sexp.Flambda.constant_defining_value_block_field and
      type  expr :=  Compiler_without_sexp.Flambda.expr and type  for_loop :=
       Compiler_without_sexp.Flambda.for_loop and type
       function_declaration := 
      Compiler_without_sexp.Flambda.function_declaration and type
       function_declarations := 
      Compiler_without_sexp.Flambda.function_declarations and type
       let_expr :=  Compiler_without_sexp.Flambda.let_expr and type
       let_mutable :=  Compiler_without_sexp.Flambda.let_mutable and type
       maybe_named :=  Compiler_without_sexp.Flambda.maybe_named and type
       move_within_set_of_closures := 
      Compiler_without_sexp.Flambda.move_within_set_of_closures and type
       named :=  Compiler_without_sexp.Flambda.named and type  program := 
      Compiler_without_sexp.Flambda.program and type  program_body := 
      Compiler_without_sexp.Flambda.program_body and type  project_closure :=
       Compiler_without_sexp.Flambda.project_closure and type  project_var :=
       Compiler_without_sexp.Flambda.project_var and type  send := 
      Compiler_without_sexp.Flambda.send and type  set_of_closures := 
      Compiler_without_sexp.Flambda.set_of_closures and type
       specialised_to :=  Compiler_without_sexp.Flambda.specialised_to and
      type  switch :=  Compiler_without_sexp.Flambda.switch and type  t := 
      Compiler_without_sexp.Flambda.t and module With_free_variables :=
      Compiler_without_sexp.Flambda.With_free_variables)
