...
type value_string_contents =
  ...
  | Contents of string 
  | Unknown_or_mutable [@@deriving sexp_of]
...
and approx = Compiler_without_sexp.Export_info.approx =
  ...
  | Value_symbol of Symbol.t [@@deriving sexp_of]
type t = Compiler_without_sexp.Export_info.t = private
  ...
  recursive: Variable.Set.t Set_of_closures_id.Map.t }[@@deriving sexp_of]
type transient = Compiler_without_sexp.Export_info.transient = private
  ...
  relevant_imported_vars_within_closure: Var_within_closure.Set.t }[@@deriving
                                                                    sexp_of]
include
  (Compiler_without_sexp.Export_info :
    module type of struct include Compiler_without_sexp.Export_info end with
      type  approx :=  Compiler_without_sexp.Export_info.approx and type
       descr :=  Compiler_without_sexp.Export_info.descr and type  t := 
      Compiler_without_sexp.Export_info.t and type  transient := 
      Compiler_without_sexp.Export_info.transient and type  value_closure := 
      Compiler_without_sexp.Export_info.value_closure and type
       value_float_array := 
      Compiler_without_sexp.Export_info.value_float_array and type
       value_float_array_contents := 
      Compiler_without_sexp.Export_info.value_float_array_contents and type
       value_set_of_closures := 
      Compiler_without_sexp.Export_info.value_set_of_closures and type
       value_string :=  Compiler_without_sexp.Export_info.value_string and
      type  value_string_contents := 
      Compiler_without_sexp.Export_info.value_string_contents and module A :=
      Compiler_without_sexp.Export_info.A)
