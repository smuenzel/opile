...
and constructor_declaration = Compiler_without_sexp.Parsetree.constructor_declaration =
  { pcd_name : string loc
...
and constructor_arguments = Compiler_without_sexp.Parsetree.constructor_arguments =
...
and extension_constructor = Compiler_without_sexp.Parsetree.extension_constructor =
...
and class_type_field_desc = Compiler_without_sexp.Parsetree.class_type_field_desc =
...
and module_type_declaration = Compiler_without_sexp.Parsetree.module_type_declaration =
...
and directive_argument_desc = Compiler_without_sexp.Parsetree.directive_argument_desc =
