...
type unresolved_value = Compiler_without_sexp.Simple_value_approx.unresolved_value =
  | Set_of_closures_id of Set_of_closures_id.t
  | Symbol of Symbol.t
[@@deriving sexp_of]

type unknown_because_of = Compiler_without_sexp.Simple_value_approx.unknown_because_of =
...
and function_declarations =
      Compiler_without_sexp.Simple_value_approx.function_declarations =
  private
...
and function_body = Compiler_without_sexp.Simple_value_approx.function_body = private
...
and function_declaration =
      Compiler_without_sexp.Simple_value_approx.function_declaration =
  private
...
and value_set_of_closures =
      Compiler_without_sexp.Simple_value_approx.value_set_of_closures =
  private
...
and value_float_array = Compiler_without_sexp.Simple_value_approx.value_float_array =
...
type simplification_result = Flambda.t * simplification_summary * t [@@deriving sexp_of]

type simplification_result_named = Flambda.named * simplification_summary * t
[@@deriving sexp_of]

type get_field_result = Compiler_without_sexp.Simple_value_approx.get_field_result =
  | Ok of t
  | Unreachable
[@@deriving sexp_of]
...
type checked_approx_for_closure =
  ...
  | Wrong
  | Ok of value_closure * Variable.t option * Symbol.t option * value_set_of_closures
[@@deriving sexp_of]
...
include (
  Compiler_without_sexp.Simple_value_approx :
    module type of struct
      include Compiler_without_sexp.Simple_value_approx
    end
    with type 'a boxed_int := 'a Compiler_without_sexp.Simple_value_approx.boxed_int
     and type checked_approx_for_block :=
          Compiler_without_sexp.Simple_value_approx.checked_approx_for_block
     and type checked_approx_for_closure :=
          Compiler_without_sexp.Simple_value_approx.checked_approx_for_closure
     ...
     and type checked_approx_for_set_of_closures :=
          Compiler_without_sexp.Simple_value_approx.checked_approx_for_set_of_closures
     and type descr := Compiler_without_sexp.Simple_value_approx.descr
     and type function_body := Compiler_without_sexp.Simple_value_approx.function_body
     and type function_declaration :=
          Compiler_without_sexp.Simple_value_approx.function_declaration
     and type function_declarations :=
          Compiler_without_sexp.Simple_value_approx.function_declarations
     and type get_field_result :=
          Compiler_without_sexp.Simple_value_approx.get_field_result
     and type simplification_result :=
          Compiler_without_sexp.Simple_value_approx.simplification_result
     and type simplification_result_named :=
          Compiler_without_sexp.Simple_value_approx.simplification_result_named
     and type simplification_summary :=
          Compiler_without_sexp.Simple_value_approx.simplification_summary
     and type strict_checked_approx_for_set_of_closures :=
          Compiler_without_sexp.Simple_value_approx
          .strict_checked_approx_for_set_of_closures
     and type switch_branch_selection :=
          Compiler_without_sexp.Simple_value_approx.switch_branch_selection
     and type t := Compiler_without_sexp.Simple_value_approx.t
     and type unknown_because_of :=
          Compiler_without_sexp.Simple_value_approx.unknown_because_of
     and type unresolved_value :=
          Compiler_without_sexp.Simple_value_approx.unresolved_value
     and type value_closure := Compiler_without_sexp.Simple_value_approx.value_closure
     and type value_float_array :=
     ...
     and type value_set_of_closures :=
          Compiler_without_sexp.Simple_value_approx.value_set_of_closures
     and type value_string := Compiler_without_sexp.Simple_value_approx.value_string)
